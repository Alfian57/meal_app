...
import 'package:myapp/providers/meals_providers.dart';

enum Filter { glutenFree, lactoceFree, vegetarian, vegan }
...
final filteredMelasProvider = Provider((ref) {
  final meals = ref.watch(mealsProvider);
    ...
    return meals.where((meal) {
      ...
      if (activeFilters[Filter.lactoceFree]! && !meal.isLactoseFree) {
        return false;
      }
